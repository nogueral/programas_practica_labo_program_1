...
int main()
{
    ...
    do{
        ...
        if(cargaArchivo=='n')
        {
         retorno = controller_loadFromText("data2.csv", listaEmpleados);
         if(retorno==1)
         {
        ...
        if(cargaArchivo=='n')
        {
        retorno = controller_loadFromBinary("data2.dat", listaEmpleados);
         if(retorno==1)
         {
            printf("Carga realizada con exito!");
            len = ll_len(listaEmpleados);
        ...
        case 9:
        retorno = controller_saveAsBinary("data2.dat", listaEmpleados);
        if(retorno==1)
        {
            printf("\nOperacion realizada con exito!\n");
