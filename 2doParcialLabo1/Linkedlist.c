...
/** \brief Trae un elemento de la lista ubicado en el indice indicado
 *
 * \param this LinkedList* Puntero a la lista
...
/** \brief recorre la lista y almacena un contador al cual suma el valor de retorno de la funcion fn
 *
 * \param LinkedList* this - puntero a la lista
 * \param int(*fn)(void* pElement) - puntero a funcion
...
/** \brief recorre la lista y genera un nuevo listado segun parametro suministrado por funcion fn
 *
 * \param LinkedList* this - puntero a la lista
 * \param int(*fn)(void* pElement) - puntero a funcion
 * \return devuelve puntero a una nueva Linkedlist
 *
 */
...
LinkedList* ll_filterParametro(LinkedList* this, int (*fn) (void* pElement, char* cadena), char* cadena)
{
    LinkedList* auxLista;
    int i;
    int retorno;
